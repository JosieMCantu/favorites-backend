...
app.post('/api/favorites', async(req, res) => {
  try {
    const data = await client.query(`INSERT into yelp (name, review_count, img_url, rating, yelp_db_id, owner_id) values ($1, $2, $3, $4, $5, $6) returning *`, [req.body.name, req.body.review_count, req.body.img_url, req.body.rating, req.body.yelp_db_id, req.userId]);
